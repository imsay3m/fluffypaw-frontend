(function ($) {
	...
	function mainSlider() {
		...
		BasicSlider.slick({
			...
			fade: true,
			arrows: true,
			prevArrow: '<button type="button" class="slick-prev"><img src="img/icon/left_arrow.png" /></button>',
			nextArrow: '<button type="button" class="slick-next"><img src="img/icon/right_arrow.png" /></button>',
			responsive: [
	...
	$('.breed-services-active').owlCarousel({
		...
		autoplaySpeed: 1000,
		navText: ['<img src="img/icon/left_arrow.png" />', '<img src="img/icon/right_arrow.png" />'],
		nav: true,
		dots: false,
		responsive: {
			0: {
